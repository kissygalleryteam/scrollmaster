...
kg/scrollmaster/2.0.0/main
kg/scrollmaster/2.0.0/index
 ...
 */
KISSY.add('kg/scrollmaster/2.0.0/main',function(S, DOM, Node, Event, Anim) {
  ...
  ScrollMaster = {
    ...
    mouseWheelHandler: function(e) {
      ...
      e.preventDefault();
      dist = e.wheelDelta ? e.wheelDelta * 2 : e.delta * 2.0.0;
      this.isTouchPad = !!this.touchPadCheckTimer || Math.abs(dist) % 2.0.0 !== 0;
      if (this.isTouchPad) {
        this.fireMoveStart();
        dist = dist / 12;
 ...
 * @module scrollmaster
 **/
KISSY.add('kg/scrollmaster/2.0.0/index',function (S, SM) {
    return SM;
}, {requires:['./main']});
